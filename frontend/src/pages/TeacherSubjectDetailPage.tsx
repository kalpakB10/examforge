...
interface Chapter {
  ...
  // U.6: per-type + per-subType counts for the summary chips.
  questionCounts?: {
                        ...
                        <div className="px-6 py-4 flex items-center gap-4 hover:bg-gray-50 transition-colors group">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex flex-wrap gap-1.5 mt-1">
                              {/* U.6: at-a-glance question bank breakdown per chapter.
                                  Falls back to old single "N questions" chip if
                                  the backend doesn't yet return questionCounts. */}
                              {(() => {
                                const c = ch.questionCounts;
                                if (!c) {
                                  return <span className="text-xs text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-full">{ch._count?.questions ?? 0} questions</span>;
                                }
                                if (c.total === 0) {
                                  return <span className="text-xs text-gray-400 bg-gray-50 px-2 py-0.5 rounded-full italic">no questions yet</span>;
                                }
                                return (
                                  <>
